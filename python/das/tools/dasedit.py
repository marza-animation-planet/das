...
def main() -> int:
    ...
    while i < n:
        ...
        if arg in ("-st", "--schema-type"):
            ...
            print(
                "  -dm/--dark-mode                           : Use a dark color scheme (windows / linux only)"
            )
    ...
    if not echo_only:
        ...
        class Window(QtWidgets.QMainWindow):
            def __init__(self, data=None, path=None, parent=None):
                ...
                self.editWidget = das.qtui.Editor(
                    data, name=name, readonly=readonly, headers=[], parent=centralWidget
                )
            ...
            def onOpen(self):
                if not readonly and self.editWidget.hasDataChanged():
                    rv = QtWidgets.QMessageBox.question(
                        self,
                        "Save Current Data",
                        "Data has changed since it has been loaded.\nWould you like to save the changes?",
        ...
        if Qt.__binding__ in ("PySide2", "PyQt5"):
            ...
            if darkmode or sys.platform not in ("win32", "darwin"):
                style = "plastique"
        if style:
            if not style in [x.lower() for x in QtWidgets.QStyleFactory.keys()]:
                style = ""
            else:
        ...
        if style == "plastique" and darkmode:
            ...
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.WindowText, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.Base, QtGui.QColor(100, 100, 100)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.AlternateBase, QtGui.QColor(90, 90, 90)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.ToolTipBase, QtGui.QColor(255, 255, 220)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.ToolTipText, QtGui.QColor(0, 0, 0)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.Text, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(QtGui.QPalette.Active, QtGui.QPalette.Button, QtGui.QColor(80, 80, 80))
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.ButtonText, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.Highlight, QtGui.QColor(247, 147, 30)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.HighlightedText, QtGui.QColor(255, 255, 255)
            )
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.BrightText, QtGui.QColor(255, 255, 255)
            )
            ...
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.Midlight, QtGui.QColor(80, 80, 80)
            )
            ...
            palette.setColor(
                QtGui.QPalette.Active, QtGui.QPalette.LinkVisited, QtGui.QColor(200, 70, 255)
            )

            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Window, QtGui.QColor(50, 50, 50)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.WindowText, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Base, QtGui.QColor(100, 100, 100)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.AlternateBase, QtGui.QColor(90, 90, 90)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.ToolTipBase, QtGui.QColor(255, 255, 220)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.ToolTipText, QtGui.QColor(0, 0, 0)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Text, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Button, QtGui.QColor(80, 80, 80)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.ButtonText, QtGui.QColor(191, 191, 191)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Highlight, QtGui.QColor(247, 147, 30)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.HighlightedText, QtGui.QColor(255, 255, 255)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.BrightText, QtGui.QColor(255, 255, 255)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Shadow, QtGui.QColor(30, 30, 30)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Light, QtGui.QColor(80, 80, 80)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Midlight, QtGui.QColor(80, 80, 80)
            )
            ...
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.Link, QtGui.QColor(70, 70, 255)
            )
            palette.setColor(
                QtGui.QPalette.Inactive, QtGui.QPalette.LinkVisited, QtGui.QColor(200, 70, 255)
            )

            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Window, QtGui.QColor(50, 50, 50)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, QtGui.QColor(0, 0, 0)
            )
            palette.setColor(QtGui.QPalette.Disabled, QtGui.QPalette.Base, QtGui.QColor(60, 60, 60))
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.AlternateBase, QtGui.QColor(90, 90, 90)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipBase, QtGui.QColor(255, 255, 220)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, QtGui.QColor(0, 0, 0)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Text, QtGui.QColor(141, 141, 141)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Button, QtGui.QColor(80, 80, 80)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.ButtonText, QtGui.QColor(0, 0, 0)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Highlight, QtGui.QColor(247, 147, 30)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.HighlightedText, QtGui.QColor(205, 205, 205)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.BrightText, QtGui.QColor(205, 205, 205)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Shadow, QtGui.QColor(30, 30, 30)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Light, QtGui.QColor(80, 80, 80)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Midlight, QtGui.QColor(80, 80, 80)
            )
            ...
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.Link, QtGui.QColor(70, 70, 255)
            )
            palette.setColor(
                QtGui.QPalette.Disabled, QtGui.QPalette.LinkVisited, QtGui.QColor(200, 70, 255)
            )
